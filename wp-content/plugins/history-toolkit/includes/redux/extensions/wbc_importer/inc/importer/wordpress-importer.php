...
<?php endif; ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php esc_attr('Submit', 'wordpress-importer' ); ?>" /></p>
</form>
<?php
	}
	...
	function author_select( $n, $author ) {
		...
		wp_dropdown_users( array( 'name' => "user_map[$n]", 'multi' => true, 'shhistory_option_all' => __( '- Select -', 'wordpress-importer' ) ) );
