...
if ( have_posts() ) :
	...
	the_posts_pagination( array(
		'prev_text'          => wp_kses( __( '<i class="fa fa-angle-double-left"></i>', "history" ), array( 'i' => array( 'class' => array() ) ) ),
		'next_text'          => wp_kses( __( '<i class="fa fa-angle-double-right"></i>', "history" ), array( 'i' => array( 'class' => array() ) ) ),
